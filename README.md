...
- Marin Kitagawa is a Folder Type bot which represents `Highest Stability`, `Highest Performance` and `Developer / User friendly`.
...
#### 📌 To start bot again ( While you are inside Marin Kitagawa folder {use `cd Marin-Kitagawa-MD` to get inside the folder} )
